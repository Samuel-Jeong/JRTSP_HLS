package rtsp.protocol.rtcp.module;
...
public class NtpUtils {
     ...
     *
     * @param ntp1 The most significant word of the NTP time stamp > NTP Seconds
     * @param ntp2 The least significant word of the NTP time stamp > NTP Fraction
