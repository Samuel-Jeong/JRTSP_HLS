...
public class Buffer {
     ...
     */
    public static final int FLAG_NO_SYNC = (FLAG_NO_DROP | FLAG_NO_WAIT);
     ...
     */
    public static final int FLAG_SYSTEM_TIME = (1 << 7);
     ...
     * two packets.)
     */
    public static final int FLAG_RELATIVE_TIME = (1 << 8);
     ...
     */
    public static final int FLAG_FLUSH = (1 << 9);

    /**
     * This is a marker bit used by the system.  Do not attempt to use
     * or overwrite this flag.
     */
    public static final int FLAG_SYSTEM_MARKER = (1 << 10);
     ...
     *
     */
    public static final int FLAG_RTP_MARKER = (1 << 11);

    /**
     * Indicates that the <CODE>Buffer</CODE> carries a time stamp that's
     * in RTP (NTP) time units.
     */
    public static final int FLAG_RTP_TIME = (1 << 12);
     ...
     */
    public static final int FLAG_BUF_OVERFLOWN = (1 << 13);
     ...
     */
    public static final int FLAG_BUF_UNDERFLOWN = (1 << 14);

    /**
     * Indicates that the data is arriving from a live (real-time) source.
     */
    public static final int FLAG_LIVE_DATA = (1 << 15);
