...
/**
 * @class public class Format implements Cloneable, Serializable
 * @brief Format class
 */
public class Format implements Cloneable, Serializable {
     ...
     */
    public static final Class<? extends int[]> intArray = int[].class;

    /**
     * The data object required by the <CODE>Format</CODE> is a short array.
     */
    public static final Class<? extends short[]> shortArray = short[].class;

    /**
     * The data object required by the <CODE>Format</CODE> is a byte array.
     */
    public static final Class<? extends byte[]> byteArray = byte[].class;

    /**
     * The data object required by the <CODE>Format</CODE> is an array of <CODE>Format</CODE> objects.
     */
    public static final Class<? extends Format[]> formatArray = Format[].class;

    protected Class dataType = byteArray;
    protected Class<? extends Format> clz = getClass();	// Cache the to optimize on
    ...
    public boolean equals(Object format) {
        ...
        return dataType == otherType && (encoding.equals(otherEncoding) || otherEncoding != null && isSameEncoding((Format) format));
    }
