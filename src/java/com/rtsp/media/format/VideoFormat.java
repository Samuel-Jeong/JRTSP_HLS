...
/**
 * @class public class VideoFormat extends Format
 * @brief VideoFormat class
 */
public class VideoFormat extends Format {
     ...
     * for this <CODE>VideoFormat</CODE>.
     */
    ...
    /**
     * Constructs a <CODE>VideoFormat</CODE> with  the specified attributes.
     * @param encoding  A <CODE>String</CODE> that describes the encoding
     * type for this <CODE>VideoFormat</CODE>.
    ...
    /**
     * Gets the dimensions of a video frame in this <code>VideoFormat</code>.
    ...
    /**
     * Creates a clone of this <code>VideoFormat</code> by copying each field to
     * the clone.
    ...
    /**
     * Gets the frame rate associated with this <code>VideoFormat</code>.
     ...
     * <CODE>Format</CODE> into this <CODE>VideoFormat</CODE>.
     ...
     * <CODE>VideoFormat</CODE>. For example: "RGB, 352x240, ...".
     * @return A <CODE>String</CODE> that describes the
     * <code>VideoFormat</code> attributes.
     */
    ...
    /**
     * Compares the specified <CODE>Format</CODE> with this <code>VideoFormat</code>.
     * Returns <CODE>true</CODE> only if the specified <CODE>Format</CODE>
     * is a <CODE>VideoFormat</CODE> object and all of
