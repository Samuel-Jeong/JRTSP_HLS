...
public class RtpPacket implements Serializable {
     ...
     * receiver.
     */
    private final long[] csrcList = null;
    ...
    public RtpPacket(byte[] data, int dataLength) {
        ...
        int vToSn = ByteUtil.bytesToInt(vToSnBytes, true);
        ...
        timeStamp = ByteUtil.bytesToLong(timeStampLongBytes, true);
        ...
        ssrc = ByteUtil.bytesToLong(ssrcLongBytes, true);
        offset += ssrcLength;
    ...
    public byte[] getData() {
        ...
        byte[] vToSnBytes = ByteUtil.intToBytes(vToSn, true);
        byte[] timeStampBytes = ByteUtil.intToBytes((int) timeStamp, true);
        byte[] ssrcBytes = ByteUtil.intToBytes((int) ssrc, true);
