package com.rtsp.protocol;//class RTPpacket
...
public class RtpPacket {
    ...
    public RtpPacket(byte[] packet, int packet_size)
    {
        ...
        if (packet_size >= HEADER_SIZE) 
        {
            ...
            System.arraycopy(packet, HEADER_SIZE, payload, 0, packet_size - 12);
    ...
    public int getpacket(byte[] packet)
    {
        ...
        if (payload_size >= 0) {
            System.arraycopy(payload, 0, packet, 12, payload_size);
        }
